...
def ensure_h3_runtime_patches():
    """Ensure both hooks are active.

    Competing H3 chaining packs are refused. Compatible PackedLayout observers
    such as SolAttn Morton are wrapped rather than treated as owners.
    """
    with _LOCK:
